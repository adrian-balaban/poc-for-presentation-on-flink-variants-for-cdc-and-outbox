...
/**
 * Applies the shared exactly-once checkpoint configuration used by every Flink
 * variant in this POC. Centralising it keeps all variants in lock-step — change
 * the interval/timeout once here rather than in four entry classes.
 */
public final class CheckpointConfigurer {
    ...
    /**
     * Enables exactly-once checkpointing on the given environment with the
     * POC-standard interval, timeout, pause, and concurrency settings.
     */
