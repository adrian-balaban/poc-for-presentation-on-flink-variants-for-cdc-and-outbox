...
/**
 * Routes each CDC event to an enriched output.
 * In a real connector this would fan out to per-table Kafka topics;
 * here it annotates each event with the variant name for demo purposes.
 */
