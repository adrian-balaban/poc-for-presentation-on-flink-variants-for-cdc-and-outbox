...
/**
 * Routes each outbox event to its destination Kafka topic based on the
 * "destination" field in the JSON payload.
 *
 * In production: use side outputs (one per destination) for exactly-once
