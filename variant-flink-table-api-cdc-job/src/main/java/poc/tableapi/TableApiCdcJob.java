 ...
 *
 * <p>Uses Flink's Table API with the mysql-cdc connector. Schema is declared in SQL DDL; Flink
 * handles deserialization automatically. Good for connectors that may grow SQL joins or
 * aggregations. ~220 lines in the real connector vs ~100 for DataStream.
 *
 * <p>Server-ID range comes from {@code JobConfig#tableApiServerId}.
 */
